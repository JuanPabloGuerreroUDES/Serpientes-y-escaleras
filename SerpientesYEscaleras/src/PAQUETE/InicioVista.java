...
public class InicioVista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmbbxFicha3.setSelectedIndex(3);
        ...
        cmbbxFicha4.setSelectedIndex(2);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        switch(numeroJugadores){
            case "2": 
                if(txtNombreJ1.getText().equals("")||txtNombreJ2.getText().equals("")){
                ...
                }else if(txtNombreJ3.getText().isBlank()&&txtNombreJ4.getText().isBlank()){
                    ...
                    Jugador[] jugadoresEnviar=new Jugador[2];
                    jugadoresEnviar[0]=jugador1;
                    jugadoresEnviar[1]=jugador2;
                    
                    
                    
                    Juego10X10 juego =new Juego10X10();
                    juego.setJugadores2(jugador1, jugador2, jugadoresEnviar);
                    dispose();
                    juego.setVisible(true);
                }else{
                    JOptionPane.showMessageDialog(rootPane, "Solo hay 2 jugadores");
            ...
            case "3":
                if(txtNombreJ1.getText().equals("")||txtNombreJ2.getText().equals("")||
                    ...
                    JOptionPane.showMessageDialog(rootPane, "Los nombres no pueden ser iguales");
                        ...
                        cmbbxFicha1.getSelectedItem().equals(cmbbxFicha3.getSelectedItem())||
                        cmbbxFicha2.getSelectedItem().equals(cmbbxFicha3.getSelectedItem())){
                    JOptionPane.showMessageDialog(rootPane, "Las fichas no pueden ser iguales");
                }else if(txtNombreJ4.getText().isEmpty()){
                    jugador1.setNombre(txtNombreJ1.getText());
                    ficha1= (String) cmbbxFicha1.getSelectedItem();
                    jugador1.setFicha(ficha1);
                    ...
                    Juego10X10 juego =new Juego10X10();
                    juego.setJugadores3(jugador1, jugador2, jugador3, jugadores);
                    dispose();
                    juego.setVisible(true);
                }else{
                    JOptionPane.showMessageDialog(rootPane, "Solo hay 3 jugadores disponibles");
                }
            ...
            case "4":
                if(txtNombreJ1.getText().equals("")||txtNombreJ2.getText().equals("")||
                    ...
                    JOptionPane.showMessageDialog(rootPane, "Los nombres no pueden ser iguales");
                        ...
                        cmbbxFicha1.getSelectedItem()==(cmbbxFicha3.getSelectedItem())||
                        cmbbxFicha2.getSelectedItem()==(cmbbxFicha3.getSelectedItem())||
                        cmbbxFicha3.getSelectedItem()==(cmbbxFicha4.getSelectedItem())||
                        cmbbxFicha4.getSelectedItem()==(cmbbxFicha1.getSelectedItem())||
                        cmbbxFicha4.getSelectedItem()==(cmbbxFicha2.getSelectedItem())){
                    JOptionPane.showMessageDialog(rootPane, "Las fichas no pueden ser iguales");
                }else{
                    jugador1.setNombre(txtNombreJ1.getText()); 
                    ficha1= (String) cmbbxFicha1.getSelectedItem();
                    ...
                    Juego10X10 juego =new Juego10X10();
                    juego.setJugadores4(jugador1, jugador2, jugador3, jugador4, jugadores);
                    dispose();
                    juego.setVisible(true);
                }
